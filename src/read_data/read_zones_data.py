...
def validate_epjson_file(file_path):
    ...
    try:
        ...
        required_objects = [
            "Version", "Building", "SimulationControl", 
            "Site:Location", "RunPeriod", "SizingPeriod:DesignDay",
            "GlobalGeometryRules"
        ]
        ...
        if "SimulationControl" in data:
            ...
            print(f"Run simulation for sizing periods: {sim_props.get('run_simulation_for_sizing_periods', 'Not specified')}")
            print(f"Run simulation for weather file: {sim_props.get('run_simulation_for_weather_file_run_periods', 'Not specified')}")
        ...
        hvac_objects = [
            "AirLoopHVAC", "ZoneHVAC:EquipmentConnections", 
            "AirTerminal:SingleDuct:VAV:Reheat", "Boiler:HotWater", 
            "Chiller:Electric", "Coil:Cooling:DX"
        ]
        ...
        material_types = ["Material", "Material:NoMass", "Material:AirGap", "WindowMaterial:SimpleGlazingSystem"]
        ...
        load_objects = [
            ...
            "GasEquipment", "OtherEquipment", "ZoneInfiltration:DesignFlowRate"
        ]
        ...
        if "Zone" in data and "BuildingSurface:Detailed" in data:
            ...
            for surface_id, surface_props in surfaces.items():
                if "outside_boundary_condition" in surface_props and surface_props["outside_boundary_condition"] == "Surface":
